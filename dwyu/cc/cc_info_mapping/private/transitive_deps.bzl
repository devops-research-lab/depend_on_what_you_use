...
_DwyuTransitiveDepsCcInfo = provider(
    ...
    fields = {
        ...
        "deps_to_compilation_context": "Dictionary mapping the Label of a dependency providing CcInfo to its CcInfo.compilation_context. All transitive dependencies of this dependency are merged into this compilation_context.",
    },
)
